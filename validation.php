            ...
            <form class="form-horizontal" action="dbinsertca.php" method="post">
              <div class="col-md-2">
                <select name="ps" class="form-control" >
                  ...
                  global $connection;
                  $i=$_SESSION['id'];
                  $query1="SELECT sid FROM observer_student WHERE oid1='$i'";
